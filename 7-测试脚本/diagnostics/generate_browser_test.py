#!/usr/bin/env python3
"""
前端诊断助手：生成可在浏览器 Console 中执行的诊断脚本
"""
...
print("✓ 已生成浏览器诊断脚本")
print("\n请在浏览器 DevTools Console 中复制粘贴以下代码：\n")
print(script)
print("\n\n或保存以下内容到文件后通过 Ctrl+V 粘贴到浏览器 Console：")
with open('browser_diagnostic.js', 'w', encoding='utf-8') as f:
    f.write(script)
print("已保存到 browser_diagnostic.js")
