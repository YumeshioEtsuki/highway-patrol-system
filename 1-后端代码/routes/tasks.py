...
from utils.deps import get_current_user, get_current_admin_qs, CurrentUser
from tasks import (
    compress_photo,
    check_photo_quality,
    export_large_excel,
...
async def submit_compress_photo(
    ...
    try:
        # 提交任务
        task = compress_photo.delay(photo_path, quality)
...
async def submit_quality_check(
    ...
    """
    try:
        task = check_photo_quality.delay(photo_path)
