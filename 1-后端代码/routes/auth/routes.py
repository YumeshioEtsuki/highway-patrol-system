...
from core.deps import get_current_user, CurrentUser, create_access_token
from core.exceptions import BusinessException, AuthException
...
async def change_password(
    ...
    try:
        ...
        if req.username:
            ...
            # 直接更新为新密码，不需要再次验证旧密码
            from services.patrol_service import get_db_connection
