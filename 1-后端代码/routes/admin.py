...
from models.schemas import AdminCompleteRequest, ApiResponse
from utils.utils import reinit_database, verify_database, get_database_status
from utils.deps import get_current_admin, get_current_admin_qs, CurrentUser
...
@cache_response(ttl=300, key_prefix="admin:patrol:list")
...
async def generate_data(
    ...
    """生成随机巡查记录数据（需要管理员权限）"""
    from models.tasks import _cache_clear
